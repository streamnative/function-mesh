...
![Version: 0.2.32](https://img.shields.io/badge/Version-0.2.32-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.24.1-rc.1](https://img.shields.io/badge/AppVersion-0.24.1--rc.1-informational?style=flat-square)
...
| operatorImage | string | `"streamnative/function-mesh:v0.24.1-rc.1"` |  |
