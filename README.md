...
```bash
curl -sSL https://github.com/streamnative/function-mesh/releases/download/v0.11.2-rc-1/install.sh | bash
```
...
| ------------------------------------------------------------ | --------------- | --------------- | --------------- | --------------- | --------------- | --------------- | --------------- |
| [`v0.11.1`](https://github.com/streamnative/function-mesh/releases/tag/v0.11.1) | ✗               | ✔               | ✔               | ✔               | ✔               | ✔               | ✔               |
