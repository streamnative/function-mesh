...
```bash
curl -sSL https://github.com/streamnative/function-mesh/releases/download/v0.20.1/install.sh | bash
```
...
|---------------------------------------------------------------------------------|---------------|--------------|---------------|----------------|-----------------| --------------- | --------------- |
| [`v0.20.1`](https://github.com/streamnative/function-mesh/releases/tag/v0.20.0) | ✔             | ✔            | ✔             | ✔               | ✔               | ✔               | ✔               |
