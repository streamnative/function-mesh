...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PulsarRuntime) DeepCopyInto(out *PulsarRuntime) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PulsarRuntime.
func (in *PulsarRuntime) DeepCopy() *PulsarRuntime {
	if in == nil {
		return nil
	}
	out := new(PulsarRuntime)
	in.DeepCopyInto(out)
	return out
}
