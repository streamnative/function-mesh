...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CryptoSecrets) DeepCopyInto(out *CryptoSecrets) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CryptoSecrets.
func (in *CryptoSecrets) DeepCopy() *CryptoSecrets {
	if in == nil {
		return nil
	}
	out := new(CryptoSecrets)
	in.DeepCopyInto(out)
	return out
}
