...
func (in *CryptoConfig) DeepCopyInto(out *CryptoConfig) {
	*out = *in
	...
	if in.CryptoKeyReaderConfigs != nil {
		in, out := &in.CryptoKeyReaderConfigs, &out.CryptoKeyReaderConfigs
		*out = make([]CryptoKeyReaderConfig, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CryptoKeyReaderConfig) DeepCopyInto(out *CryptoKeyReaderConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CryptoKeyReaderConfig.
func (in *CryptoKeyReaderConfig) DeepCopy() *CryptoKeyReaderConfig {
	if in == nil {
		return nil
	}
	out := new(CryptoKeyReaderConfig)
	in.DeepCopyInto(out)
	return out
}
