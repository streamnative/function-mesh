...
func (in *FunctionMeshSpec) DeepCopyInto(out *FunctionMeshSpec) {
	*out = *in
	...
	if in.GenericResources != nil {
		...
		*out = make([]GenericResourceSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FunctionMeshStatus) DeepCopyInto(out *FunctionMeshStatus) {
	*out = *in
	...
	if in.GenericResourceConditions != nil {
		in, out := &in.GenericResourceConditions, &out.GenericResourceConditions
		*out = make(map[string]ResourceCondition, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *GenericResourceSpec) DeepCopyInto(out *GenericResourceSpec) {
	*out = *in
	...
	if in.ReadyFields != nil {
		in, out := &in.ReadyFields, &out.ReadyFields
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
