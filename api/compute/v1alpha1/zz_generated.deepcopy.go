...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *McpSseConfig) DeepCopyInto(out *McpSseConfig) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new McpSseConfig.
func (in *McpSseConfig) DeepCopy() *McpSseConfig {
	if in == nil {
		return nil
	}
	out := new(McpSseConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ToolsConfig) DeepCopyInto(out *ToolsConfig) {
	*out = *in
	...
	if in.IncludeTools != nil {
		in, out := &in.IncludeTools, &out.IncludeTools
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
