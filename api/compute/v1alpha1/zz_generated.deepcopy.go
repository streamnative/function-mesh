...
func (in *ConnectorDefinition) DeepCopyInto(out *ConnectorDefinition) {
	*out = *in
	if in.SourceConfigFieldDefinitions != nil {
		in, out := &in.SourceConfigFieldDefinitions, &out.SourceConfigFieldDefinitions
		*out = make([]ConfigFieldDefinition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SinkConfigFieldDefinitions != nil {
		in, out := &in.SinkConfigFieldDefinitions, &out.SinkConfigFieldDefinitions
		*out = make([]ConfigFieldDefinition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
