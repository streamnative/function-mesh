...
public class V1alpha1SourceSpecPodScaleIOSecretRef {
    public static final String SERIALIZED_NAME_NAME = "name";
    @SerializedName(SERIALIZED_NAME_NAME)
    private String name;


    public V1alpha1SourceSpecPodScaleIOSecretRef name(String name) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodScaleIOSecretRef v1alpha1SourceSpecPodScaleIOSecretRef = (V1alpha1SourceSpecPodScaleIOSecretRef) o;
        return Objects.equals(this.name, v1alpha1SourceSpecPodScaleIOSecretRef.name);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodScaleIOSecretRef {\n");
