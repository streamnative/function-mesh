...
public class V1alpha1SourceSpecPodIscsiSecretRef {
    public static final String SERIALIZED_NAME_NAME = "name";
    @SerializedName(SERIALIZED_NAME_NAME)
    private String name;


    public V1alpha1SourceSpecPodIscsiSecretRef name(String name) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodIscsiSecretRef v1alpha1SourceSpecPodIscsiSecretRef = (V1alpha1SourceSpecPodIscsiSecretRef) o;
        return Objects.equals(this.name, v1alpha1SourceSpecPodIscsiSecretRef.name);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodIscsiSecretRef {\n");
