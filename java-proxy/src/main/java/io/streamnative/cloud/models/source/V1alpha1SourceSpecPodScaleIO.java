...
public class V1alpha1SourceSpecPodScaleIO {
    ...
    private V1alpha1SourceSpecPodScaleIOSecretRef secretRef;
    ...
    public V1alpha1SourceSpecPodScaleIO fsType(String fsType) {
    ...
    public V1alpha1SourceSpecPodScaleIO gateway(String gateway) {
    ...
    public V1alpha1SourceSpecPodScaleIO protectionDomain(String protectionDomain) {
    ...
    public V1alpha1SourceSpecPodScaleIO readOnly(Boolean readOnly) {
    ...
    public V1alpha1SourceSpecPodScaleIO secretRef(V1alpha1SourceSpecPodScaleIOSecretRef secretRef) {
    ...
    public V1alpha1SourceSpecPodScaleIOSecretRef getSecretRef() {
        return secretRef;
    }


    public void setSecretRef(V1alpha1SourceSpecPodScaleIOSecretRef secretRef) {
        this.secretRef = secretRef;
    }


    public V1alpha1SourceSpecPodScaleIO sslEnabled(Boolean sslEnabled) {
    ...
    public V1alpha1SourceSpecPodScaleIO storageMode(String storageMode) {
    ...
    public V1alpha1SourceSpecPodScaleIO storagePool(String storagePool) {
    ...
    public V1alpha1SourceSpecPodScaleIO system(String system) {
    ...
    public V1alpha1SourceSpecPodScaleIO volumeName(String volumeName) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodScaleIO v1alpha1SourceSpecPodScaleIO = (V1alpha1SourceSpecPodScaleIO) o;
        return Objects.equals(this.fsType, v1alpha1SourceSpecPodScaleIO.fsType) &&
                Objects.equals(this.gateway, v1alpha1SourceSpecPodScaleIO.gateway) &&
                Objects.equals(this.protectionDomain, v1alpha1SourceSpecPodScaleIO.protectionDomain) &&
                Objects.equals(this.readOnly, v1alpha1SourceSpecPodScaleIO.readOnly) &&
                Objects.equals(this.secretRef, v1alpha1SourceSpecPodScaleIO.secretRef) &&
                Objects.equals(this.sslEnabled, v1alpha1SourceSpecPodScaleIO.sslEnabled) &&
                Objects.equals(this.storageMode, v1alpha1SourceSpecPodScaleIO.storageMode) &&
                Objects.equals(this.storagePool, v1alpha1SourceSpecPodScaleIO.storagePool) &&
                Objects.equals(this.system, v1alpha1SourceSpecPodScaleIO.system) &&
                Objects.equals(this.volumeName, v1alpha1SourceSpecPodScaleIO.volumeName);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodScaleIO {\n");
