...
public class V1alpha1SourceSpecPodFc {
    ...
    public V1alpha1SourceSpecPodFc fsType(String fsType) {
    ...
    public V1alpha1SourceSpecPodFc lun(Integer lun) {
    ...
    public V1alpha1SourceSpecPodFc readOnly(Boolean readOnly) {
    ...
    public V1alpha1SourceSpecPodFc targetWWNs(List<String> targetWWNs) {

        this.targetWWNs = targetWWNs;
        return this;
    }

    public V1alpha1SourceSpecPodFc addTargetWWNsItem(String targetWWNsItem) {
    ...
    public V1alpha1SourceSpecPodFc wwids(List<String> wwids) {

        this.wwids = wwids;
        return this;
    }

    public V1alpha1SourceSpecPodFc addWwidsItem(String wwidsItem) {
        if (this.wwids == null) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodFc v1alpha1SourceSpecPodFc = (V1alpha1SourceSpecPodFc) o;
        return Objects.equals(this.fsType, v1alpha1SourceSpecPodFc.fsType) &&
                Objects.equals(this.lun, v1alpha1SourceSpecPodFc.lun) &&
                Objects.equals(this.readOnly, v1alpha1SourceSpecPodFc.readOnly) &&
                Objects.equals(this.targetWWNs, v1alpha1SourceSpecPodFc.targetWWNs) &&
                Objects.equals(this.wwids, v1alpha1SourceSpecPodFc.wwids);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodFc {\n");
