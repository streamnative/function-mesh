...
public class V1alpha1SourceSpecPodIscsi {
    ...
    private V1alpha1SourceSpecPodIscsiSecretRef secretRef;
    ...
    public V1alpha1SourceSpecPodIscsi chapAuthDiscovery(Boolean chapAuthDiscovery) {
    ...
    public V1alpha1SourceSpecPodIscsi chapAuthSession(Boolean chapAuthSession) {
    ...
    public V1alpha1SourceSpecPodIscsi fsType(String fsType) {
    ...
    public V1alpha1SourceSpecPodIscsi initiatorName(String initiatorName) {
    ...
    public V1alpha1SourceSpecPodIscsi iqn(String iqn) {
    ...
    public V1alpha1SourceSpecPodIscsi iscsiInterface(String iscsiInterface) {
    ...
    public V1alpha1SourceSpecPodIscsi lun(Integer lun) {
    ...
    public V1alpha1SourceSpecPodIscsi portals(List<String> portals) {

        this.portals = portals;
        return this;
    }

    public V1alpha1SourceSpecPodIscsi addPortalsItem(String portalsItem) {
    ...
    public V1alpha1SourceSpecPodIscsi readOnly(Boolean readOnly) {
    ...
    public V1alpha1SourceSpecPodIscsi secretRef(V1alpha1SourceSpecPodIscsiSecretRef secretRef) {
    ...
    public V1alpha1SourceSpecPodIscsiSecretRef getSecretRef() {
        return secretRef;
    }


    public void setSecretRef(V1alpha1SourceSpecPodIscsiSecretRef secretRef) {
        this.secretRef = secretRef;
    }


    public V1alpha1SourceSpecPodIscsi targetPortal(String targetPortal) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodIscsi v1alpha1SourceSpecPodIscsi = (V1alpha1SourceSpecPodIscsi) o;
        return Objects.equals(this.chapAuthDiscovery, v1alpha1SourceSpecPodIscsi.chapAuthDiscovery) &&
                Objects.equals(this.chapAuthSession, v1alpha1SourceSpecPodIscsi.chapAuthSession) &&
                Objects.equals(this.fsType, v1alpha1SourceSpecPodIscsi.fsType) &&
                Objects.equals(this.initiatorName, v1alpha1SourceSpecPodIscsi.initiatorName) &&
                Objects.equals(this.iqn, v1alpha1SourceSpecPodIscsi.iqn) &&
                Objects.equals(this.iscsiInterface, v1alpha1SourceSpecPodIscsi.iscsiInterface) &&
                Objects.equals(this.lun, v1alpha1SourceSpecPodIscsi.lun) &&
                Objects.equals(this.portals, v1alpha1SourceSpecPodIscsi.portals) &&
                Objects.equals(this.readOnly, v1alpha1SourceSpecPodIscsi.readOnly) &&
                Objects.equals(this.secretRef, v1alpha1SourceSpecPodIscsi.secretRef) &&
                Objects.equals(this.targetPortal, v1alpha1SourceSpecPodIscsi.targetPortal);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodIscsi {\n");
