...
/**
 * V1alpha1SourceSpecOutputProducerConf
 */
...
public class V1alpha1SourceSpecOutputProducerConf {
    public static final String SERIALIZED_NAME_CRYPTO_CONFIG = "cryptoConfig";
    @SerializedName(SERIALIZED_NAME_CRYPTO_CONFIG)
    private V1alpha1SourceSpecOutputProducerConfCryptoConfig cryptoConfig;
    ...
    public V1alpha1SourceSpecOutputProducerConf cryptoConfig(V1alpha1SourceSpecOutputProducerConfCryptoConfig cryptoConfig) {
    ...
    public V1alpha1SourceSpecOutputProducerConfCryptoConfig getCryptoConfig() {
        return cryptoConfig;
    }


    public void setCryptoConfig(V1alpha1SourceSpecOutputProducerConfCryptoConfig cryptoConfig) {
        this.cryptoConfig = cryptoConfig;
    }


    public V1alpha1SourceSpecOutputProducerConf maxPendingMessages(Integer maxPendingMessages) {
    ...
    public V1alpha1SourceSpecOutputProducerConf maxPendingMessagesAcrossPartitions(Integer maxPendingMessagesAcrossPartitions) {
    ...
    public V1alpha1SourceSpecOutputProducerConf useThreadLocalProducers(Boolean useThreadLocalProducers) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecOutputProducerConf v1alpha1SourceSpecOutputProducerConf = (V1alpha1SourceSpecOutputProducerConf) o;
        return Objects.equals(this.cryptoConfig, v1alpha1SourceSpecOutputProducerConf.cryptoConfig) &&
                Objects.equals(this.maxPendingMessages, v1alpha1SourceSpecOutputProducerConf.maxPendingMessages) &&
                Objects.equals(this.maxPendingMessagesAcrossPartitions, v1alpha1SourceSpecOutputProducerConf.maxPendingMessagesAcrossPartitions) &&
                Objects.equals(this.useThreadLocalProducers, v1alpha1SourceSpecOutputProducerConf.useThreadLocalProducers);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecOutputProducerConf {\n");
