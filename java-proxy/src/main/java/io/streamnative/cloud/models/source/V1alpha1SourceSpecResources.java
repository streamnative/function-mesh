...
public class V1alpha1SourceSpecResources {
    ...
    public V1alpha1SourceSpecResources limits(Map<String, Object> limits) {

        this.limits = limits;
        return this;
    }

    public V1alpha1SourceSpecResources putLimitsItem(String key, Object limitsItem) {
        if (this.limits == null) {
    ...
    public V1alpha1SourceSpecResources requests(Map<String, Object> requests) {

        this.requests = requests;
        return this;
    }

    public V1alpha1SourceSpecResources putRequestsItem(String key, Object requestsItem) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecResources v1alpha1SourceSpecResources = (V1alpha1SourceSpecResources) o;
        return Objects.equals(this.limits, v1alpha1SourceSpecResources.limits) &&
                Objects.equals(this.requests, v1alpha1SourceSpecResources.requests);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecResources {\n");
