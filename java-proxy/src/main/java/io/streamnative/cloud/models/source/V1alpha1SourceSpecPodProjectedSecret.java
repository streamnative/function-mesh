...
public class V1alpha1SourceSpecPodProjectedSecret {
    ...
    public V1alpha1SourceSpecPodProjectedSecret items(List<V1alpha1SourceSpecPodConfigMapItems> items) {

        this.items = items;
        return this;
    }

    public V1alpha1SourceSpecPodProjectedSecret addItemsItem(V1alpha1SourceSpecPodConfigMapItems itemsItem) {
        if (this.items == null) {
    ...
    public V1alpha1SourceSpecPodProjectedSecret name(String name) {
    ...
    public V1alpha1SourceSpecPodProjectedSecret optional(Boolean optional) {
    ...
    public boolean equals(Object o) {
        ...
        V1alpha1SourceSpecPodProjectedSecret v1alpha1SourceSpecPodProjectedSecret = (V1alpha1SourceSpecPodProjectedSecret) o;
        return Objects.equals(this.items, v1alpha1SourceSpecPodProjectedSecret.items) &&
                Objects.equals(this.name, v1alpha1SourceSpecPodProjectedSecret.name) &&
                Objects.equals(this.optional, v1alpha1SourceSpecPodProjectedSecret.optional);
    }
    ...
    public String toString() {
        ...
        sb.append("class V1alpha1SourceSpecPodProjectedSecret {\n");
