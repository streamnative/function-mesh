...
public class V1alpha1FunctionSpecPodSecurityContextWindowsOptions {
  ...
  public V1alpha1FunctionSpecPodSecurityContextWindowsOptions gmsaCredentialSpec(String gmsaCredentialSpec) {
  ...
  **/
  ...
  public V1alpha1FunctionSpecPodSecurityContextWindowsOptions gmsaCredentialSpecName(String gmsaCredentialSpecName) {
  ...
  **/
  ...
  public V1alpha1FunctionSpecPodSecurityContextWindowsOptions runAsUserName(String runAsUserName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1FunctionSpecPodSecurityContextWindowsOptions v1alpha1FunctionSpecPodSecurityContextWindowsOptions = (V1alpha1FunctionSpecPodSecurityContextWindowsOptions) o;
    return Objects.equals(this.gmsaCredentialSpec, v1alpha1FunctionSpecPodSecurityContextWindowsOptions.gmsaCredentialSpec) &&
        Objects.equals(this.gmsaCredentialSpecName, v1alpha1FunctionSpecPodSecurityContextWindowsOptions.gmsaCredentialSpecName) &&
        Objects.equals(this.runAsUserName, v1alpha1FunctionSpecPodSecurityContextWindowsOptions.runAsUserName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1FunctionSpecPodSecurityContextWindowsOptions {\n");
