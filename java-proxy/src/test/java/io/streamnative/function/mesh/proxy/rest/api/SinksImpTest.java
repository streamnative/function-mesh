...
public class SinksImpTest {
    ...
    private final String group = "cloud.streamnative.io";
    ...
    public void testRegisterSink()
        ...
        String testBody =
                "{\n"
                        ...
                        + "    \"selfLink\": \"/apis/cloud.streamnative.io/v1alpha1/namespaces/default/sinks/sink-sample\",\n"
